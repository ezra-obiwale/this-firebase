    ...
    firebase: function (fbConfig) {
        ...
        this.watch(function (location, success, error) {
            _this.FB().watch(location, function (data, id) {
                ...
                _this.__.callable(_this.fbSuccess.create[location] || success)
                ...
                if (_this.fbConfig.uid)
                    data[_this.fbConfig.uid] = id;
                _this.__.callable(_this.fbSuccess.update[location] || success)
                ...
                if (_this.fbConfig.uid)
                    data[_this.fbConfig.uid] = id;
                _this.__.callable(_this.fbSuccess.delete[location] || success)
