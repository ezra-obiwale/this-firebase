...
ThisApp.extend({FB:function(){var _this=this;return{updatedEvents:{added:{},changed:{},removed:{}},eventCallbacks:{added:{},changed:{},removed:{}},isConnected:function(callback){return this.read('.info/connected',callback);},onConnected:function(callback){this.ref('.info/connected').on('value',function(snap){if(snap.val())
...
return true;});return this.cacheData(true).setDataKey(null);}});